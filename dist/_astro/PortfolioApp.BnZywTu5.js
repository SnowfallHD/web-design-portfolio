...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function jd(i,e,t){const n=new Float32Array(kn),r=new B(0,1,0);return new $t({name:"SphericalGaussianBlur",defines:{n:kn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:yr(),fragmentShader:`
	...
	`}class cl extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new tl(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new at(5,5,5),s=new $t({name:"CubemapFromEquirect",uniforms:gi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Dt,blending:mn});s.uniforms.tEquirect.value=t;const a=new ke(r,s),o=t.minFilter;return t.minFilter===Gn&&(t.minFilter=wt),new Jc(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function qd(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,m=!1){return u==null?null:m?a(u):s(u)}function s(u){if(u&&u.isTexture){const m=u.mapping;if(m===Cr||m===Pr)if(e.has(u)){const v=e.get(u).texture;return o(v,u.mapping)}else{const v=u.image;if(v&&v.height>0){const T=new cl(v.height);return T.fromEquirectangularTexture(i,u),e.set(u,T),u.addEventListener("dispose",l),o(T.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const m=u.mapping,v=m===Cr||m===Pr,T=m===Hn||m===pi;if(v||T){let f=t.get(u);const h=f!==void 0?f.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==h)return n===null&&(n=new lo(i)),f=v?n.fromEquirectangular(u,f):n.fromCubemap(u,f),f.texture.pmremVersion=u.pmremVersion,t.set(u,f),f.texture;if(f!==void 0)return f.texture;{const x=u.image;return v&&x&&x.height>0||T&&x&&c(x)?(n===null&&(n=new lo(i)),f=v?n.fromEquirectangular(u):n.fromCubemap(u),f.texture.pmremVersion=u.pmremVersion,t.set(u,f),u.addEventListener("dispose",d),f.texture):null}}}return u}function o(u,m){return m===Cr?u.mapping=Hn:m===Pr&&(u.mapping=pi),u}function c(u){let m=0;const v=6;for(let T=0;T<v;T++)u[T]!==void 0&&m++;return m===v}function l(u){const m=u.target;m.removeEventListener("dispose",l);const v=e.get(m);v!==void 0&&(e.delete(m),v.dispose())}function d(u){const m=u.target;m.removeEventListener("dispose",d);const v=t.get(m);v!==void 0&&(t.delete(m),v.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:p}}function Yd(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Zs("WebGLRenderer: "+n+" extension not supported."),r}}}function $d(i,e,t,n){const r={},s=new WeakMap;function a(p){const u=p.target;u.index!==null&&e.remove(u.index);for(const v in u.attributes)e.remove(u.attributes[v]);u.removeEventListener("dispose",a),delete r[u.id];const m=s.get(u);m&&(e.remove(m),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(p,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function c(p){const u=p.attributes;for(const m in u)e.update(u[m],i.ARRAY_BUFFER)}function l(p){const u=[],m=p.index,v=p.attributes.position;let T=0;if(v===void 0)return;if(m!==null){const x=m.array;T=m.version;for(let y=0,E=x.length;y<E;y+=3){const R=x[y+0],A=x[y+1],C=x[y+2];u.push(R,A,A,C,C,R)}}else{const x=v.array;T=v.version;for(let y=0,E=x.length/3-1;y<E;y+=3){const R=y+0,A=y+1,C=y+2;u.push(R,A,A,C,C,R)}}const f=new(v.count>=65535?Jo:Zo)(u,1);f.version=T;const h=s.get(p);h&&e.remove(h),s.set(p,f)}function d(p){const u=s.get(p);if(u){const m=p.index;m!==null&&u.version<m.version&&l(p)}else l(p);return s.get(p)}return{get:o,update:c,getWireframeAttribute:d}}function Kd(i,e,t){let n;function r(p){n=p}let s,a;function o(p){s=p.type,a=p.bytesPerElement}function c(p,u){i.drawElements(n,u,s,p*a),t.update(u,n,1)}function l(p,u,m){m!==0&&(i.drawElementsInstanced(n,u,s,p*a,m),t.update(u,n,m))}function d(p,u,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,u,0,s,p,0,m);let T=0;for(let f=0;f<m;f++)T+=u[f];t.update(T,n,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=d}function Zd(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:je("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Jd(i,e,t){const n=new WeakMap,r=new dt;function s(a,o,c){const l=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0;let u=n.get(o);if(u===void 0||u.count!==p){let w=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",w)};u!==void 0&&u.texture.dispose();const m=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,T=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],x=o.morphAttributes.color||[];let y=0;m===!0&&(y=1),v===!0&&(y=2),T===!0&&(y=3);let E=o.attributes.position.count*y,R=1;E>e.maxTextureSize&&(R=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const A=new Float32Array(E*R*4*p),C=new Yo(A,E,R,p);C.type=tn,C.needsUpdate=!0;const _=y*4;for(let D=0;D<p;D++){const P=f[D],O=h[D],W=x[D],X=E*R*4*D;for(let U=0;U<P.count;U++){const V=U*_;m===!0&&(r.fromBufferAttribute(P,U),A[X+V+0]=r.x,A[X+V+1]=r.y,A[X+V+2]=r.z,A[X+V+3]=0),v===!0&&(r.fromBufferAttribute(O,U),A[X+V+4]=r.x,A[X+V+5]=r.y,A[X+V+6]=r.z,A[X+V+7]=0),T===!0&&(r.fromBufferAttribute(W,U),A[X+V+8]=r.x,A[X+V+9]=r.y,A[X+V+10]=r.z,A[X+V+11]=W.itemSize===4?r.w:1)}}u={count:p,texture:C,size:new He(E,R)},n.set(o,u),o.addEventListener("dispose",w)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let m=0;for(let T=0;T<l.length;T++)m+=l[T];const v=o.morphTargetsRelative?1:1-m;c.getUniforms().setValue(i,"morphTargetBaseInfluence",v),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:s}}function Qd(i,e,t,n,r){let s=new WeakMap;function a(l){const d=r.render.frame,p=l.geometry,u=e.get(l,p);if(s.get(u)!==d&&(e.update(u),s.set(u,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==d&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,d))),l.isSkinnedMesh){const m=l.skeleton;s.get(m)!==d&&(m.update(),s.set(m,d))}return u}function o(){s=new WeakMap}function c(l){const d=l.target;d.removeEventListener("dispose",c),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}const ef={[Do]:"LINEAR_TONE_MAPPING",[Io]:"REINHARD_TONE_MAPPING",[No]:"CINEON_TONE_MAPPING",[Uo]:"ACES_FILMIC_TONE_MAPPING",[Oo]:"AGX_TONE_MAPPING",[Bo]:"NEUTRAL_TONE_MAPPING",[Fo]:"CUSTOM_TONE_MAPPING"};function tf(i,e,t,n,r){const s=new sn(e,t,{type:i,depthBuffer:n,stencilBuffer:r,depthTexture:n?new mi(e,t):void 0}),a=new sn(e,t,{type:_n,depthBuffer:!1,stencilBuffer:!1}),o=new It;o.setAttribute("position",new Et([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Et([0,2,0,0,2,0],2));const c=new Xc({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)}const Jf={[Do]:"Linear",[Io]:"Reinhard",[No]:"Cineon",[Uo]:"ACESFilmic",[Oo]:"AgX",[Bo]:"Neutral",[Fo]:"Custom"};function Qf(i,e){const t=Jf[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const cr=new B;function ep(){Ge.getLuminanceCoefficients(cr);const i=cr.x.toFixed(4),e=cr.y.toFixed(4),t=cr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`;class Hp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new nl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new $t({vertexShader:Gp,fragmentShader:Vp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ke(new Fi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Wp extends jn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,d=null,p=null,u=null,m=null,v=null;const T=typeof XRWebGLBinding<"u",f=new Hp,h={},x=t.getContextAttributes();let y=null,E=null;const R=[],A=[],C=new He;let _=null;const w=new Bt;w.viewport=new dt;const D=new Bt;D.viewport=new dt;const P=[w,D],O=new Qc;let W=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let de=R[Z];return de===void 0&&(de=new zr,R[Z]=de),de.getTargetRaySpace()},this.getControllerGrip=function(Z){let de=R[Z];return de===void 0&&(de=new zr,R[Z]=de),de.getGripSpace()},this.getHand=function(Z){let de=R[Z];return de===void 0&&(de=new zr,R[Z]=de),de.getHandSpace()};function U(Z){const de=A.indexOf(Z.inputSource);if(de===-1)return;const Q=R[de];Q!==void 0&&(Q.update(Z.inputSource,Z.frame,l||a),Q.dispatchEvent({type:Z.type,data:Z.inputSource}))}function V(){r.removeEventListener("select",U),r.removeEventListener("selectstart",U),r.removeEventListener("selectend",U),r.removeEventListener("squeeze",U),r.removeEventListener("squeezestart",U),r.removeEventListener("squeezeend",U),r.removeEventListener("end",V),r.removeEventListener("inputsourceschange",L);for(let Z=0;Z<R.length;Z++){const de=A[Z];de!==null&&(A[Z]=null,R[Z].disconnect(de))}W=null,X=null,f.reset();for(const Z in h)delete h[Z];e.setRenderTarget(y),m=null,u=null,p=null,r=null,E=null,Le.stop(),n.isPresenting=!1,e.setPixelRatio(_),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Z){l=Z},this.getBaseLayer=function(){return u!==null?u:m},this.getBinding=function(){return p===null&&T&&(p=new XRWebGLBinding(r,t)),p},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(Z){if(r=Z,r!==null){if(y=e.getRenderTarget(),r.addEventListener("select",U),r.addEventListener("selectstart",U),r.addEventListener("selectend",U),r.addEventListener("squeeze",U),r.addEventListener("squeezestart",U),r.addEventListener("squeezeend",U),r.addEventListener("end",V),r.addEventListener("inputsourceschange",L),x.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(C),T&&"createProjectionLayer"in XRWebGLBinding.prototype){let Q=null,Se=null,we=null;x.depth&&(we=x.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Q=x.stencil?Vn:xn,Se=x.stencil?Li:an);const Ae={colorFormat:t.RGBA8,depthFormat:we,scaleFactor:s};p=this.getBinding(),u=p.createProjectionLayer(Ae),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),E=new sn(u.textureWidth,u.textureHeight,{format:qt,type:zt,depthTexture:new mi(u.textureWidth,u.textureHeight,Se,void 0,void 0,void 0,void 0,void 0,void 0,Q),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const Q={antialias:x.antialias,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,Q),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),E=new sn(m.framebufferWidth,m.framebufferHeight,{format:qt,type:zt,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Le.setContext(r),Le.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return f.getDepthTexture()};function L(Z){for(let de=0;de<Z.removed.length;de++){const Q=Z.removed[de],Se=A.indexOf(Q);Se>=0&&(A[Se]=null,R[Se].disconnect(Q))}for(let de=0;de<Z.added.length;de++){const Q=Z.added[de];let Se=A.indexOf(Q);if(Se===-1){for(let Ae=0;Ae<R.length;Ae++)if(Ae>=A.length){A.push(Q),Se=Ae;break}else if(A[Ae]===null){A[Ae]=Q,Se=Ae;break}if(Se===-1)break}const we=R[Se];we&&we.connect(Q)}}const j=new B,J=new B;function ne(Z,de,Q){j.setFromMatrixPosition(de.matrixWorld),J.setFromMatrixPosition(Q.matrixWorld);const Se=j.distanceTo(J),we=de.projectionMatrix.elements,Ae=Q.projectionMatrix.elements,st=we[14]/(we[10]-1),Oe=we[14]/(we[10]+1),$e=(we[9]+1)/we[5],rt=(we[9]-1)/we[5],Be=(we[8]-1)/we[0],_t=(Ae[8]+1)/Ae[0],ot=st*Be,Nt=st*_t,N=Se/(-Be+_t),xt=N*-Be;if(de.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(xt),Z.translateZ(N),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),we[10]===-1)Z.projectionMatrix.copy(de.projectionMatrix),Z.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{const ze=st+N,nt=Oe+N,ce=ot-xt,ct=Nt+(Se-xt),b=$e*Oe/nt*ze,g=rt*Oe/nt*ze;Z.projectionMatrix.makePerspective(ce,ct,b,g,ze,nt),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function _e(Z,de){de===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(de.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(r===null)return;let de=Z.near,Q=Z.far;f.texture!==null&&(f.depthNear>0&&(de=f.depthNear),f.depthFar>0&&(Q=f.depthFar)),O.near=D.near=w.near=de,O.far=D.far=w.far=Q,(W!==O.near||X!==O.far)&&(r.updateRenderState({depthNear:O.near,depthFar:O.far}),W=O.near,X=O.far),O.layers.mask=Z.layers.mask|6,w.layers.mask=O.layers.mask&-5,D.layers.mask=O.layers.mask&-3;const Se=Z.parent,we=O.cameras;_e(O,Se);for(let Ae=0;Ae<we.length;Ae++)_e(we[Ae],Se);we.length===2?ne(O,w,D):O.projectionMatrix.copy(w.projectionMatrix),Me(Z,O,Se)};function Me(Z,de,Q){Q===null?Z.matrix.copy(de.matrixWorld):(Z.matrix.copy(Q.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(de.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(de.projectionMatrix),Z.projectionMatrixInverse.copy(de.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Js*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(u===null&&m===null))return c},this.setFoveation=function(Z){c=Z,u!==null&&(u.fixedFoveation=Z),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Z)},this.hasDepthSensing=function(){return f.texture!==null},this.getDepthSensingMesh=function(){return f.getMesh(O)},this.getCameraTexture=function(Z){return h[Z]};let We=null;function Ke(Z,de){if(d=de.getViewerPose(l||a),v=de,d!==null){const Q=d.views;m!==null&&(e.setRenderTargetFramebuffer(E,m.framebuffer),e.setRenderTarget(E));let Se=!1;Q.length!==O.cameras.length&&(O.cameras.length=0,Se=!0);for(let Oe=0;Oe<Q.length;Oe++){const $e=Q[Oe];let rt=null;if(m!==null)rt=m.getViewport($e);else{const _t=p.getViewSubImage(u,$e);rt=_t.viewport,Oe===0&&(e.setRenderTargetTextures(E,_t.colorTexture,_t.depthStencilTexture),e.setRenderTarget(E))}let Be=P[Oe];Be===void 0&&(Be=new Bt,Be.layers.enable(Oe),Be.viewport=new dt,P[Oe]=Be),Be.matrix.fromArray($e.transform.matrix),Be.matrix.decompose(Be.position,Be.quaternion,Be.scale),Be.projectionMatrix.fromArray($e.projectionMatrix),Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(),Be.viewport.set(rt.x,rt.y,rt.width,rt.height),Oe===0&&(O.matrix.copy(Be.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),Se===!0&&O.cameras.push(Be)}const we=r.enabledFeatures;if(we&&we.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&T){p=n.getBinding();const Oe=p.getDepthInformation(Q[0]);Oe&&Oe.isValid&&Oe.texture&&f.init(Oe,r.renderState)}if(we&&we.includes("camera-access")&&T){e.state.unbindTexture(),p=n.getBinding();for(let Oe=0;Oe<Q.length;Oe++){const $e=Q[Oe].camera;if($e){let rt=h[$e];rt||(rt=new nl,h[$e]=rt);const Be=p.getCameraImage($e);rt.sourceTexture=Be}}}}for(let Q=0;Q<R.length;Q++){const Se=A[Q],we=R[Q];Se!==null&&we!==void 0&&we.update(Se,de,l||a)}We&&We(Z,de),de.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:de}),v=null}const Le=new ol;Le.setAnimationLoop(Ke),this.setAnimationLoop=function(Z){We=Z},this.dispose=function(){}}}const Xp=new lt,pl=new Pe;pl.set(-1,0,0,0,1,0,0,0,1);function jp(i,e){function t(f,h){f.matrixAutoUpdate===!0&&f.updateMatrix(),h.value.copy(f.matrix)}function n(f,h){h.color.getRGB(f.fogColor.value,il(i)),h.isFog?(f.fogNear.value=h.near,f.fogFar.value=h.far):h.isFogExp2&&(f.fogDensity.value=h.density)}function r(f,h,x,y,E){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?s(f,h):h.isMeshLambertMaterial?(s(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(s(f,h),p(f,h)):h.isMeshPhongMaterial?(s(f,h),d(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(s(f,h),u(f,h),h.isMeshPhysicalMaterial&&m(f,h,E)):h.isMeshMatcapMaterial?(s(f,h),v(f,h)):h.isMeshDepthMaterial?s(f,h):h.isMeshDistanceMaterial?(s(f,h),T(f,h)):h.isMeshNormalMaterial?s(f,h):h.isLineBasicMaterial?(a(f,h),h.isLineDashedMaterial&&o(f,h)):h.isPointsMaterial?c(f,h,x,y):h.isSpriteMaterial?l(f,h):h.isShadowMaterial?(f.color.value.copy(h.color),f.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(f,h){f.opacity.value=h.opacity,h.color&&f.diffuse.value.copy(h.color),h.emissive&&f.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.bumpMap&&(f.bumpMap.value=h.bumpMap,t(h.bumpMap,f.bumpMapTransform),f.bumpScale.value=h.bumpScale,h.side===Dt&&(f.bumpScale.value*=-1)),h.normalMap&&(f.normalMap.value=h.normalMap,t(h.normalMap,f.normalMapTransform),f.normalScale.value.copy(h.normalScale),h.side===Dt&&f.normalScale.value.negate()),h.displacementMap&&(f.displacementMap.value=h.displacementMap,t(h.displacementMap,f.displacementMapTransform),f.displacementScale.value=h.displacementScale,f.displacementBias.value=h.displacementBias),h.emissiveMap&&(f.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,f.emissiveMapTransform)),h.specularMap&&(f.specularMap.value=h.specularMap,t(h.specularMap,f.specularMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest);const x=e.get(h),y=x.envMap,E=x.envMapRotation;y&&(f.envMap.value=y,f.envMapRotation.value.setFromMatrix4(Xp.makeRotationFromEuler(E)).transpose(),y.isCubeTexture&&y.isRenderTargetTexture===!1&&f.envMapRotation.value.premultiply(pl),f.reflectivity.value=h.reflectivity,f.ior.value=h.ior,f.refractionRatio.value=h.refractionRatio),h.lightMap&&(f.lightMap.value=h.lightMap,f.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,f.lightMapTransform)),h.aoMap&&(f.aoMap.value=h.aoMap,f.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,f.aoMapTransform))}function a(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform))}function o(f,h){f.dashSize.value=h.dashSize,f.totalSize.value=h.dashSize+h.gapSize,f.scale.value=h.scale}function c(f,h,x,y){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.size.value=h.size*x,f.scale.value=y*.5,h.map&&(f.map.value=h.map,t(h.map,f.uvTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function l(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.rotation.value=h.rotation,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function d(f,h){f.specular.value.copy(h.specular),f.shininess.value=Math.max(h.shininess,1e-4)}function p(f,h){h.gradientMap&&(f.gradientMap.value=h.gradientMap)}function u(f,h){f.metalness.value=h.metalness,h.metalnessMap&&(f.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,f.metalnessMapTransform)),f.roughness.value=h.roughness,h.roughnessMap&&(f.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,f.roughnessMapTransform)),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)}function m(f,h,x){f.ior.value=h.ior,h.sheen>0&&(f.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),f.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(f.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,f.sheenColorMapTransform)),h.sheenRoughnessMap&&(f.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,f.sheenRoughnessMapTransform))),h.clearcoat>0&&(f.clearcoat.value=h.clearcoat,f.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(f.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,f.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(f.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Dt&&f.clearcoatNormalScale.value.negate())),h.dispersion>0&&(f.dispersion.value=h.dispersion),h.iridescence>0&&(f.iridescence.value=h.iridescence,f.iridescenceIOR.value=h.iridescenceIOR,f.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(f.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,f.iridescenceMapTransform)),h.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),h.transmission>0&&(f.transmission.value=h.transmission,f.transmissionSamplerMap.value=x.texture,f.transmissionSamplerSize.value.set(x.width,x.height),h.transmissionMap&&(f.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,f.transmissionMapTransform)),f.thickness.value=h.thickness,h.thicknessMap&&(f.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=h.attenuationDistance,f.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(f.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(f.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=h.specularIntensity,f.specularColor.value.copy(h.specularColor),h.specularColorMap&&(f.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,f.specularColorMapTransform)),h.specularIntensityMap&&(f.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,f.specularIntensityMapTransform))}function v(f,h){h.matcap&&(f.matcap.value=h.matcap)}function T(f,h){const x=e.get(h).light;f.referencePosition.value.setFromMatrixPosition(x.matrixWorld),f.nearDistance.value=x.shadow.camera.near,f.farDistance.value=x.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function qp(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(x,y){const E=y.program;n.uniformBlockBinding(x,E)}function l(x,y){let E=r[x.id];E===void 0&&(v(x),E=d(x),r[x.id]=E,x.addEventListener("dispose",f));const R=y.program;n.updateUBOMapping(x,R);const A=e.render.frame;s[x.id]!==A&&(u(x),s[x.id]=A)}function d(x){const y=p();x.__bindingPointIndex=y;const E=i.createBuffer(),R=x.__size,A=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,R,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,y,E),E}function p(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return je("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(x){const y=r[x.id],E=x.uniforms,R=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,y);for(let A=0,C=E.length;A<C;A++){const _=Array.isArray(E[A])?E[A]:[E[A]];for(let w=0,D=_.length;w<D;w++){const P=_[w];if(m(P,A,w,R)===!0){const O=P.__offset,W=Array.isArray(P.value)?P.value:[P.value];let X=0;for(let U=0;U<W.length;U++){const V=W[U],L=T(V);typeof V=="number"||typeof V=="boolean"?(P.__data[0]=V,i.bufferSubData(i.UNIFORM_BUFFER,O+X,P.__data)):V.isMatrix3?(P.__data[0]=V.elements[0],P.__data[1]=V.elements[1],P.__data[2]=V.elements[2],P.__data[3]=0,P.__data[4]=V.elements[3],P.__data[5]=V.elements[4],P.__data[6]=V.elements[5],P.__data[7]=0,P.__data[8]=V.elements[6],P.__data[9]=V.elements[7],P.__data[10]=V.elements[8],P.__data[11]=0):ArrayBuffer.isView(V)?P.__data.set(new V.constructor(V.buffer,V.byteOffset,P.__data.length)):(V.toArray(P.__data,X),X+=L.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,O,P.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(x,y,E,R){const A=x.value,C=y+"_"+E;if(R[C]===void 0)return typeof A=="number"||typeof A=="boolean"?R[C]=A:ArrayBuffer.isView(A)?R[C]=A.slice():R[C]=A.clone(),!0;{const _=R[C];if(typeof A=="number"||typeof A=="boolean"){if(_!==A)return R[C]=A,!0}else{if(ArrayBuffer.isView(A))return!0;if(_.equals(A)===!1)return _.copy(A),!0}}return!1}function v(x){const y=x.uniforms;let E=0;const R=16;for(let C=0,_=y.length;C<_;C++){const w=Array.isArray(y[C])?y[C]:[y[C]];for(let D=0,P=w.length;D<P;D++){const O=w[D],W=Array.isArray(O.value)?O.value:[O.value];for(let X=0,U=W.length;X<U;X++){const V=W[X],L=T(V),j=E%R,J=j%L.boundary,ne=j+J;E+=J,ne!==0&&R-ne<L.storage&&(E+=R-ne),O.__data=new Float32Array(L.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=E,E+=L.storage}}}const A=E%R;return A>0&&(E+=R-A),x.__size=E,x.__cache={},this}function T(x){const y={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(y.boundary=4,y.storage=4):x.isVector2?(y.boundary=8,y.storage=8):x.isVector3||x.isColor?(y.boundary=16,y.storage=12):x.isVector4?(y.boundary=16,y.storage=16):x.isMatrix3?(y.boundary=48,y.storage=48):x.isMatrix4?(y.boundary=64,y.storage=64):x.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(y.boundary=16,y.storage=x.byteLength):Re("WebGLRenderer: Unsupported uniform value type.",x),y}function f(x){const y=x.target;y.removeEventListener("dispose",f);const E=a.indexOf(y.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(r[y.id]),delete r[y.id],delete s[y.id]}function h(){for(const x in r)i.deleteBuffer(r[x]);a=[],r={},s={}}return{bind:c,update:l,dispose:h}}const Yp=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Qt=null;function $p(){return Qt===null&&(Qt=new Nc(Yp,16,16,Wn,_n),Qt.name="DFG_LUT",Qt.minFilter=wt,Qt.magFilter=wt,Qt.wrapS=pn,Qt.wrapT=pn,Qt.generateMipmaps=!1,Qt.needsUpdate=!0),Qt}class Kp{constructor(e={}){const{canvas:t=hc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:m=zt}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const T=m,f=new Set([la,oa,aa]),h=new Set([zt,an,Pi,Li,ra,sa]),x=new Uint32Array(4),y=new Int32Array(4),E=new B;let R=null,A=null;const C=[],_=[];let w=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const D=this;let P=!1,O=null;this._outputColorSpace=Vt;let W=0,X=0,U=null,V=-1,L=null;const j=new dt,J=new dt;let ne=null;const _e=new qe(0);let Me=0,We=t.width,Ke=t.height,Le=1,Z=null,de=null;const Q=new dt(0,0,We,Ke),Se=new dt(0,0,We,Ke);let we=!1;const Ae=new fa;let st=!1,Oe=!1;const $e=new lt,rt=new B,Be=new dt,_t={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ot=!1;function Nt(){return U===null?Le:1}let N=n;function xt(M,F){return t.getContext(M,F)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${na}`),t.addEventListener("webglcontextlost",ee,!1),t.addEventListener("webglcontextrestored",be,!1),t.addEventListener("webglcontextcreationerror",De,!1),N===null){const F="webgl2";if(N=xt(F,M),N===null)throw xt(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw je("WebGLRenderer: "+M.message),M}let ze,nt,ce,ct,b,g,z,$,te,ie,le,q,K,pe,xe,ae,re,Ce,Ne,Ye,I,se,Y;function me(){ze=new Yd(N),ze.init(),I=new kp(N,ze),nt=new kd(N,ze,e,I),ce=new Bp(N,ze),nt.reversedDepthBuffer&&u&&ce.buffers.depth.setReversed(!0),ct=new Zd(N),b=new yp,g=new zp(N,ze,ce,b,nt,I,ct),z=new qd(D),$=new tu(N),se=new Bd(N,$),te=new $d(N,$,ct,se),ie=new Qd(N,te,$,se,ct),Ce=new Jd(N,nt,g),xe=new Gd(b),le=new bp(D,z,ze,nt,se,xe),q=new jp(D,b),K=new Ap,pe=new Dp(ze),re=new Od(D,z,ce,ie,v,c),ae=new Op(D,ie,nt),Y=new qp(N,ct,nt,ce),Ne=new zd(N,ze,ct),Ye=new Kd(N,ze,ct),ct.programs=le.programs,D.capabilities=nt,D.extensions=ze,D.properties=b,D.renderLists=K,D.shadowMap=ae,D.state=ce,D.info=ct}me(),T!==zt&&(w=new tf(T,t.width,t.height,r,s));const oe=new Wp(D,N);this.xr=oe,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){const M=ze.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=ze.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Le},this.setPixelRatio=function(M){M!==void 0&&(Le=M,this.setSize(We,Ke,!1))},this.getSize=function(M){return M.set(We,Ke)},this.setSize=function(M,F,H=!0){if(oe.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}We=M,Ke=F,t.width=Math.floor(M*Le),t.height=Math.floor(F*Le),H===!0&&(t.style.width=M+"px",t.style.height=F+"px"),w!==null&&w.setSize(t.width,t.height),this.setViewport(0,0,M,F)},this.getDrawingBufferSize=function(M){return M.set(We*Le,Ke*Le).floor()},this.setDrawingBufferSize=function(M,F,H){We=M,Ke=F,Le=H,t.width=Math.floor(M*H),t.height=Math.floor(F*H),this.setViewport(0,0,M,F)},this.setEffects=function(M){if(T===zt){je("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let F=0;F<M.length;F++)if(M[F].isOutputPass===!0){Re("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(j)},this.getViewport=function(M){return M.copy(Q)},this.setViewport=function(M,F,H,k){M.isVector4?Q.set(M.x,M.y,M.z,M.w):Q.set(M,F,H,k),ce.viewport(j.copy(Q).multiplyScalar(Le).round())},this.getScissor=function(M){return M.copy(Se)},this.setScissor=function(M,F,H,k){M.isVector4?Se.set(M.x,M.y,M.z,M.w):Se.set(M,F,H,k),ce.scissor(J.copy(Se).multiplyScalar(Le).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(M){ce.setScissorTest(we=M)},this.setOpaqueSort=function(M){Z=M},this.setTransparentSort=function(M){de=M},this.getClearColor=function(M){return M.copy(re.getClearColor())},this.setClearColor=function(){re.setClearColor(...arguments)},this.getClearAlpha=function(){return re.getClearAlpha()},this.setClearAlpha=function(){re.setClearAlpha(...arguments)},this.clear=function(M=!0,F=!0,H=!0){let k=0;if(M){let G=!1;if(U!==null){const fe=U.texture.format;G=f.has(fe)}if(G){const fe=U.texture.type,ve=h.has(fe),he=re.getClearColor(),Ee=re.getClearAlpha(),ye=he.r,Ie=he.g,Fe=he.b;ve?(x[0]=ye,x[1]=Ie,x[2]=Fe,x[3]=Ee,N.clearBufferuiv(N.COLOR,0,x)):(y[0]=ye,y[1]=Ie,y[2]=Fe,y[3]=Ee,N.clearBufferiv(N.COLOR,0,y))}else k|=N.COLOR_BUFFER_BIT}F&&(k|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),H&&(k|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k!==0&&N.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(M){M.setRenderer(this),O=M},this.dispose=function(){t.removeEventListener("webglcontextlost",ee,!1),t.removeEventListener("webglcontextrestored",be,!1),t.removeEventListener("webglcontextcreationerror",De,!1),re.dispose(),K.dispose(),pe.dispose(),b.dispose(),z.dispose(),ie.dispose(),se.dispose(),Y.dispose(),le.dispose(),oe.dispose(),oe.removeEventListener("sessionstart",_a),oe.removeEventListener("sessionend",xa),In.stop()};function ee(M){M.preventDefault(),Oa("WebGLRenderer: Context Lost."),P=!0}function be(){Oa("WebGLRenderer: Context Restored."),P=!1;const M=ct.autoReset,F=ae.enabled,H=ae.autoUpdate,k=ae.needsUpdate,G=ae.type;me(),ct.autoReset=M,ae.enabled=F,ae.autoUpdate=H,ae.needsUpdate=k,ae.type=G}function De(M){je("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function ft(M){const F=M.target;F.removeEventListener("dispose",ft),Je(F)}function Je(M){on(M),b.remove(M)}function on(M){const F=b.get(M).programs;F!==void 0&&(F.forEach(function(H){le.releaseProgram(H)}),M.isShaderMaterial&&le.releaseShaderCache(M))}this.renderBufferDirect=function(M,F,H,k,G,fe){F===null&&(F=_t);const ve=G.isMesh&&G.matrixWorld.determinant()<0,he=Sl(M,F,H,k,G);ce.setMaterial(k,ve);let Ee=H.index,ye=1;if(k.wireframe===!0){if(Ee=te.getWireframeAttribute(H),Ee===void 0)return;ye=2}const Ie=H.drawRange,Fe=H.attributes.position;let Te=Ie.start*ye,Qe=(Ie.start+Ie.count)*ye;fe!==null&&(Te=Math.max(Te,fe.start*ye),Qe=Math.min(Qe,(fe.start+fe.count)*ye)),Ee!==null?(Te=Math.max(Te,0),Qe=Math.min(Qe,Ee.count)):Fe!=null&&(Te=Math.max(Te,0),Qe=Math.min(Qe,Fe.count));const pt=Qe-Te;if(pt<0||pt===1/0)return;se.setup(G,k,he,H,Ee);let ut,et=Ne;if(Ee!==null&&(ut=$.get(Ee),et=Ye,et.setIndex(ut)),G.isMesh)k.wireframe===!0?(ce.setLineWidth(k.wireframeLinewidth*Nt()),et.setMode(N.LINES)):et.setMode(N.TRIANGLES);else if(G.isLine){let yt=k.linewidth;yt===void 0&&(yt=1),ce.setLineWidth(yt*Nt()),G.isLineSegments?et.setMode(N.LINES):G.isLineLoop?et.setMode(N.LINE_LOOP):et.setMode(N.LINE_STRIP)}else G.isPoints?et.setMode(N.POINTS):G.isSprite&&et.setMode(N.TRIANGLES);if(G.isBatchedMesh)if(ze.get("WEBGL_multi_draw"))et.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const yt=G._multiDrawStarts,ge=G._multiDrawCounts,Ut=G._multiDrawCount,Xe=Ee?$.get(Ee).bytesPerElement:1,kt=b.get(k).currentProgram.getUniforms();for(let Zt=0;Zt<Ut;Zt++)kt.setValue(N,"_gl_DrawID",Zt),et.render(yt[Zt]/Xe,ge[Zt])}else if(G.isInstancedMesh)et.renderInstances(Te,pt,G.count);else if(H.isInstancedBufferGeometry){const yt=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,ge=Math.min(H.instanceCount,yt);et.renderInstances(Te,pt,ge)}else et.render(Te,pt)};function Kt(M,F,H){M.transparent===!0&&M.side===fn&&M.forceSinglePass===!1?(M.side=Dt,M.needsUpdate=!0,Bi(M,F,H),M.side=Ln,M.needsUpdate=!0,Bi(M,F,H),M.side=fn):Bi(M,F,H)}this.compile=function(M,F,H=null){H===null&&(H=M),A=pe.get(H),A.init(F),_.push(A),H.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),M!==H&&M.traverseVisible(function(G){G.isLight&&G.layers.test(F.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),A.setupLights();const k=new Set;return M.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const fe=G.material;if(fe)if(Array.isArray(fe))for(let ve=0;ve<fe.length;ve++){const he=fe[ve];Kt(he,H,G),k.add(he)}else Kt(fe,H,G),k.add(fe)}),A=_.pop(),k},this.compileAsync=function(M,F,H=null){const k=this.compile(M,F,H);return new Promise(G=>{function fe(){if(k.forEach(function(ve){b.get(ve).currentProgram.isReady()&&k.delete(ve)}),k.size===0){G(M);return}setTimeout(fe,10)}ze.get("KHR_parallel_shader_compile")!==null?fe():setTimeout(fe,10)})};let Ar=null;function vl(M){Ar&&Ar(M)}function _a(){In.stop()}function xa(){In.start()}const In=new ol;In.setAnimationLoop(vl),typeof self<"u"&&In.setContext(self),this.setAnimationLoop=function(M){Ar=M,oe.setAnimationLoop(M),M===null?In.stop():In.start()},oe.addEventListener("sessionstart",_a),oe.addEventListener("sessionend",xa),this.render=function(M,F){if(F!==void 0&&F.isCamera!==!0){je("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;O!==null&&O.renderStart(M,F);const H=oe.enabled===!0&&oe.isPresenting===!0,k=w!==null&&(U===null||H)&&w.begin(D,U);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),oe.enabled===!0&&oe.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(oe.cameraAutoUpdate===!0&&oe.updateCamera(F),F=oe.getCamera()),M.isScene===!0&&M.onBeforeRender(D,M,F,U),A=pe.get(M,_.length),A.init(F),A.state.textureUnits=g.getTextureUnits(),_.push(A),$e.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Ae.setFromProjectionMatrix($e,nn,F.reversedDepth),Oe=this.localClippingEnabled,st=xe.init(this.clippingPlanes,Oe),R=K.get(M,C.length),R.init(),C.push(R),oe.enabled===!0&&oe.isPresenting===!0){const ve=D.xr.getDepthSensingMesh();ve!==null&&wr(ve,F,-1/0,D.sortObjects)}wr(M,F,0,D.sortObjects),R.finish(),D.sortObjects===!0&&R.sort(Z,de),ot=oe.enabled===!1||oe.isPresenting===!1||oe.hasDepthSensing()===!1,ot&&re.addToRenderList(R,M),this.info.render.frame++,st===!0&&xe.beginShadows();const G=A.state.shadowsArray;if(ae.render(G,M,F),st===!0&&xe.endShadows(),this.info.autoReset===!0&&this.info.reset(),(k&&w.hasRenderPass())===!1){const ve=R.opaque,he=R.transmissive;if(A.setupLights(),F.isArrayCamera){const Ee=F.cameras;if(he.length>0)for(let ye=0,Ie=Ee.length;ye<Ie;ye++){const Fe=Ee[ye];Ma(ve,he,M,Fe)}ot&&re.render(M);for(let ye=0,Ie=Ee.length;ye<Ie;ye++){const Fe=Ee[ye];va(R,M,Fe,Fe.viewport)}}else he.length>0&&Ma(ve,he,M,F),ot&&re.render(M),va(R,M,F)}U!==null&&X===0&&(g.updateMultisampleRenderTarget(U),g.updateRenderTargetMipmap(U)),k&&w.end(D),M.isScene===!0&&M.onAfterRender(D,M,F),se.resetDefaultState(),V=-1,L=null,_.pop(),_.length>0?(A=_[_.length-1],g.setTextureUnits(A.state.textureUnits),st===!0&&xe.setGlobalState(D.clippingPlanes,A.state.camera)):A=null,C.pop(),C.length>0?R=C[C.length-1]:R=null,O!==null&&O.renderEnd()};function wr(M,F,H,k){if(M.visible===!1)return;if(M.layers.test(F.layers)){if(M.isGroup)H=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(F);else if(M.isLightProbeGrid)A.pushLightProbeGrid(M);else if(M.isLight)A.pushLight(M),M.castShadow&&A.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Ae.intersectsSprite(M)){k&&Be.setFromMatrixPosition(M.matrixWorld).applyMatrix4($e);const ve=ie.update(M),he=M.material;he.visible&&R.push(M,ve,he,H,Be.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Ae.intersectsObject(M))){const ve=ie.update(M),he=M.material;if(k&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Be.copy(M.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),Be.copy(ve.boundingSphere.center)),Be.applyMatrix4(M.matrixWorld).applyMatrix4($e)),Array.isArray(he)){const Ee=ve.groups;for(let ye=0,Ie=Ee.length;ye<Ie;ye++){const Fe=Ee[ye],Te=he[Fe.materialIndex];Te&&Te.visible&&R.push(M,ve,Te,H,Be.z,Fe)}}else he.visible&&R.push(M,ve,he,H,Be.z,null)}}const fe=M.children;for(let ve=0,he=fe.length;ve<he;ve++)wr(fe[ve],F,H,k)}function va(M,F,H,k){const{opaque:G,transmissive:fe,transparent:ve}=M;A.setupLightsView(H),st===!0&&xe.setGlobalState(D.clippingPlanes,H),k&&ce.viewport(j.copy(k)),G.length>0&&Oi(G,F,H),fe.length>0&&Oi(fe,F,H),ve.length>0&&Oi(ve,F,H),ce.buffers.depth.setTest(!0),ce.buffers.depth.setMask(!0),ce.buffers.color.setMask(!0),ce.setPolygonOffset(!1)}function Ma(M,F,H,k){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[k.id]===void 0){const Te=ze.has("EXT_color_buffer_half_float")||ze.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[k.id]=new sn(1,1,{generateMipmaps:!0,type:Te?_n:zt,minFilter:Gn,samples:Math.max(4,nt.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ge.workingColorSpace})}const fe=A.state.transmissionRenderTarget[k.id],ve=k.viewport||j;fe.setSize(ve.z*D.transmissionResolutionScale,ve.w*D.transmissionResolutionScale);const he=D.getRenderTarget(),Ee=D.getActiveCubeFace(),ye=D.getActiveMipmapLevel();D.setRenderTarget(fe),D.getClearColor(_e),Me=D.getClearAlpha(),Me<1&&D.setClearColor(16777215,.5),D.clear(),ot&&re.render(H);const Ie=D.toneMapping;D.toneMapping=rn;const Fe=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),A.setupLightsView(k),st===!0&&xe.setGlobalState(D.clippingPlanes,k),Oi(M,H,k),g.updateMultisampleRenderTarget(fe),g.updateRenderTargetMipmap(fe),ze.has("WEBGL_multisampled_render_to_texture")===!1){let Te=!1;for(let Qe=0,pt=F.length;Qe<pt;Qe++){const ut=F[Qe],{object:et,geometry:yt,material:ge,group:Ut}=ut;if(ge.side===fn&&et.layers.test(k.layers)){const Xe=ge.side;ge.side=Dt,ge.needsUpdate=!0,Sa(et,H,k,yt,ge,Ut),ge.side=Xe,ge.needsUpdate=!0,Te=!0}}Te===!0&&(g.updateMultisampleRenderTarget(fe),g.updateRenderTargetMipmap(fe))}D.setRenderTarget(he,Ee,ye),D.setClearColor(_e,Me),Fe!==void 0&&(k.viewport=Fe),D.toneMapping=Ie}function Oi(M,F,H){const k=F.isScene===!0?F.overrideMaterial:null;for(let G=0,fe=M.length;G<fe;G++){const ve=M[G],{object:he,geometry:Ee,group:ye}=ve;let Ie=ve.material;Ie.allowOverride===!0&&k!==null&&(Ie=k),he.layers.test(H.layers)&&Sa(he,F,H,Ee,Ie,ye)}}function Sa(M,F,H,k,G,fe){M.onBeforeRender(D,F,H,k,G,fe),M.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),G.onBeforeRender(D,F,H,k,M,fe),G.transparent===!0&&G.side===fn&&G.forceSinglePass===!1?(G.side=Dt,G.needsUpdate=!0,D.renderBufferDirect(H,F,k,G,M,fe),G.side=Ln,G.needsUpdate=!0,D.renderBufferDirect(H,F,k,G,M,fe),G.side=fn):D.renderBufferDirect(H,F,k,G,M,fe),M.onAfterRender(D,F,H,k,G,fe)}function Bi(M,F,H){F.isScene!==!0&&(F=_t);const k=b.get(M),G=A.state.lights,fe=A.state.shadowsArray,ve=G.state.version,he=le.getParameters(M,G.state,fe,F,H,A.state.lightProbeGridArray),Ee=le.getProgramCacheKey(he);let ye=k.programs;k.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?F.environment:null,k.fog=F.fog;const Ie=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;k.envMap=z.get(M.envMap||k.environment,Ie),k.envMapRotation=k.environment!==null&&M.envMap===null?F.environmentRotation:M.envMapRotation,ye===void 0&&(M.addEventListener("dispose",ft),ye=new Map,k.programs=ye);let Fe=ye.get(Ee);if(Fe!==void 0){if(k.currentProgram===Fe&&k.lightsStateVersion===ve)return ba(M,he),Fe}else he.uniforms=le.getUniforms(M),O!==null&&M.isNodeMaterial&&O.build(M,H,he),M.onBeforeCompile(he,D),Fe=le.acquireProgram(he,Ee),ye.set(Ee,Fe),k.uniforms=he.uniforms;const Te=k.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Te.clippingPlanes=xe.uniform),ba(M,he),k.needsLights=bl(M),k.lightsStateVersion=ve,k.needsLights&&(Te.ambientLightColor.value=G.state.ambient,Te.lightProbe.value=G.state.probe,Te.directionalLights.value=G.state.directional,Te.directionalLightShadows.value=G.state.directionalShadow,Te.spotLights.value=G.state.spot,Te.spotLightShadows.value=G.state.spotShadow,Te.rectAreaLights.value=G.state.rectArea,Te.ltc_1.value=G.state.rectAreaLTC1,Te.ltc_2.value=G.state.rectAreaLTC2,Te.pointLights.value=G.state.point,Te.pointLightShadows.value=G.state.pointShadow,Te.hemisphereLights.value=G.state.hemi,Te.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Te.spotLightMatrix.value=G.state.spotLightMatrix,Te.spotLightMap.value=G.state.spotLightMap,Te.pointShadowMatrix.value=G.state.pointShadowMatrix),k.lightProbeGrid=A.state.lightProbeGridArray.length>0,k.currentProgram=Fe,k.uniformsList=null,Fe}function Ea(M){if(M.uniformsList===null){const F=M.currentProgram.getUniforms();M.uniformsList=gr.seqWithValue(F.seq,M.uniforms)}return M.uniformsList}function ba(M,F){const H=b.get(M);H.outputColorSpace=F.outputColorSpace,H.batching=F.batching,H.batchingColor=F.batchingColor,H.instancing=F.instancing,H.instancingColor=F.instancingColor,H.instancingMorph=F.instancingMorph,H.skinning=F.skinning,H.morphTargets=F.morphTargets,H.morphNormals=F.morphNormals,H.morphColors=F.morphColors,H.morphTargetsCount=F.morphTargetsCount,H.numClippingPlanes=F.numClippingPlanes,H.numIntersection=F.numClipIntersection,H.vertexAlphas=F.vertexAlphas,H.vertexTangents=F.vertexTangents,H.toneMapping=F.toneMapping}function Ml(M,F){if(M.length===0)return null;if(M.length===1)return M[0].texture!==null?M[0]:null;E.setFromMatrixPosition(F.matrixWorld);for(let H=0,k=M.length;H<k;H++){const G=M[H];if(G.texture!==null&&G.boundingBox.containsPoint(E))return G}return null}function Sl(M,F,H,k,G){F.isScene!==!0&&(F=_t),g.resetTextureUnits();const fe=F.fog,ve=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?F.environment:null,he=U===null?D.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:Ge.workingColorSpace,Ee=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,ye=z.get(k.envMap||ve,Ee),Ie=k.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Fe=!!H.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Te=!!H.morphAttributes.position,Qe=!!H.morphAttributes.normal,pt=!!H.morphAttributes.color;let ut=rn;k.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(ut=D.toneMapping);const et=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,yt=et!==void 0?et.length:0,ge=b.get(k),Ut=A.state.lights;if(st===!0&&(Oe===!0||M!==L)){const it=M===L&&k.id===V;xe.setState(k,M,it)}let Xe=!1;k.version===ge.__version?(ge.needsLights&&ge.lightsStateVersion!==Ut.state.version||ge.outputColorSpace!==he||G.isBatchedMesh&&ge.batching===!1||!G.isBatchedMesh&&ge.batching===!0||G.isBatchedMesh&&ge.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&ge.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&ge.instancing===!1||!G.isInstancedMesh&&ge.instancing===!0||G.isSkinnedMesh&&ge.skinning===!1||!G.isSkinnedMesh&&ge.skinning===!0||G.isInstancedMesh&&ge.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&ge.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&ge.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&ge.instancingMorph===!1&&G.morphTexture!==null||ge.envMap!==ye||k.fog===!0&&ge.fog!==fe||ge.numClippingPlanes!==void 0&&(ge.numClippingPlanes!==xe.numPlanes||ge.numIntersection!==xe.numIntersection)||ge.vertexAlphas!==Ie||ge.vertexTangents!==Fe||ge.morphTargets!==Te||ge.morphNormals!==Qe||ge.morphColors!==pt||ge.toneMapping!==ut||ge.morphTargetsCount!==yt||!!ge.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(Xe=!0):(Xe=!0,ge.__version=k.version);let kt=ge.currentProgram;Xe===!0&&(kt=Bi(k,F,G),O&&k.isNodeMaterial&&O.onUpdateProgram(k,kt,ge));let Zt=!1,Mn=!1,Yn=!1;const tt=kt.getUniforms(),mt=ge.uniforms;if(ce.useProgram(kt.program)&&(Zt=!0,Mn=!0,Yn=!0),k.id!==V&&(V=k.id,Mn=!0),ge.needsLights){const it=Ml(A.state.lightProbeGridArray,G);ge.lightProbeGrid!==it&&(ge.lightProbeGrid=it,Mn=!0)}if(Zt||L!==M){ce.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),tt.setValue(N,"projectionMatrix",M.projectionMatrix),tt.setValue(N,"viewMatrix",M.matrixWorldInverse);const En=tt.map.cameraPosition;En!==void 0&&En.setValue(N,rt.setFromMatrixPosition(M.matrixWorld)),nt.logarithmicDepthBuffer&&tt.setValue(N,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&tt.setValue(N,"isOrthographic",M.isOrthographicCamera===!0),L!==M&&(L=M,Mn=!0,Yn=!0)}if(ge.needsLights&&(Ut.state.directionalShadowMap.length>0&&tt.setValue(N,"directionalShadowMap",Ut.state.directionalShadowMap,g),Ut.state.spotShadowMap.length>0&&tt.setValue(N,"spotShadowMap",Ut.state.spotShadowMap,g),Ut.state.pointShadowMap.length>0&&tt.setValue(N,"pointShadowMap",Ut.state.pointShadowMap,g)),G.isSkinnedMesh){tt.setOptional(N,G,"bindMatrix"),tt.setOptional(N,G,"bindMatrixInverse");const it=G.skeleton;it&&(it.boneTexture===null&&it.computeBoneTexture(),tt.setValue(N,"boneTexture",it.boneTexture,g))}G.isBatchedMesh&&(tt.setOptional(N,G,"batchingTexture"),tt.setValue(N,"batchingTexture",G._matricesTexture,g),tt.setOptional(N,G,"batchingIdTexture"),tt.setValue(N,"batchingIdTexture",G._indirectTexture,g),tt.setOptional(N,G,"batchingColorTexture"),G._colorsTexture!==null&&tt.setValue(N,"batchingColorTexture",G._colorsTexture,g));const Sn=H.morphAttributes;if((Sn.position!==void 0||Sn.normal!==void 0||Sn.color!==void 0)&&Ce.update(G,H,kt),(Mn||ge.receiveShadow!==G.receiveShadow)&&(ge.receiveShadow=G.receiveShadow,tt.setValue(N,"receiveShadow",G.receiveShadow)),(k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial)&&k.envMap===null&&F.environment!==null&&(mt.envMapIntensity.value=F.environmentIntensity),mt.dfgLUT!==void 0&&(mt.dfgLUT.value=$p()),Mn){if(tt.setValue(N,"toneMappingExposure",D.toneMappingExposure),ge.needsLights&&El(mt,Yn),fe&&k.fog===!0&&q.refreshFogUniforms(mt,fe),q.refreshMaterialUniforms(mt,k,Le,Ke,A.state.transmissionRenderTarget[M.id]),ge.needsLights&&ge.lightProbeGrid){const it=ge.lightProbeGrid;mt.probesSH.value=it.texture,mt.probesMin.value.copy(it.boundingBox.min),mt.probesMax.value.copy(it.boundingBox.max),mt.probesResolution.value.copy(it.resolution)}gr.upload(N,Ea(ge),mt,g)}if(k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(gr.upload(N,Ea(ge),mt,g),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&tt.setValue(N,"center",G.center),tt.setValue(N,"modelViewMatrix",G.modelViewMatrix),tt.setValue(N,"normalMatrix",G.normalMatrix),tt.setValue(N,"modelMatrix",G.matrixWorld),k.uniformsGroups!==void 0){const it=k.uniformsGroups;for(let En=0,$n=it.length;En<$n;En++){const ya=it[En];Y.update(ya,kt),Y.bind(ya,kt)}}return kt}function El(M,F){M.ambientLightColor.needsUpdate=F,M.lightProbe.needsUpdate=F,M.directionalLights.needsUpdate=F,M.directionalLightShadows.needsUpdate=F,M.pointLights.needsUpdate=F,M.pointLightShadows.needsUpdate=F,M.spotLights.needsUpdate=F,M.spotLightShadows.needsUpdate=F,M.rectAreaLights.needsUpdate=F,M.hemisphereLights.needsUpdate=F}function bl(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(M,F,H){const k=b.get(M);k.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),b.get(M.texture).__webglTexture=F,b.get(M.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:H,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,F){const H=b.get(M);H.__webglFramebuffer=F,H.__useDefaultFramebuffer=F===void 0};const yl=N.createFramebuffer();this.setRenderTarget=function(M,F=0,H=0){U=M,W=F,X=H;let k=null,G=!1,fe=!1;if(M){const he=b.get(M);if(he.__useDefaultFramebuffer!==void 0){ce.bindFramebuffer(N.FRAMEBUFFER,he.__webglFramebuffer),j.copy(M.viewport),J.copy(M.scissor),ne=M.scissorTest,ce.viewport(j),ce.scissor(J),ce.setScissorTest(ne),V=-1;return}else if(he.__webglFramebuffer===void 0)g.setupRenderTarget(M);else if(he.__hasExternalTextures)g.rebindTextures(M,b.get(M.texture).__webglTexture,b.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Ie=M.depthTexture;if(he.__boundDepthTexture!==Ie){if(Ie!==null&&b.has(Ie)&&(M.width!==Ie.image.width||M.height!==Ie.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");g.setupDepthRenderbuffer(M)}}const Ee=M.texture;(Ee.isData3DTexture||Ee.isDataArrayTexture||Ee.isCompressedArrayTexture)&&(fe=!0);const ye=b.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(ye[F])?k=ye[F][H]:k=ye[F],G=!0):M.samples>0&&g.useMultisampledRTT(M)===!1?k=b.get(M).__webglMultisampledFramebuffer:Array.isArray(ye)?k=ye[H]:k=ye,j.copy(M.viewport),J.copy(M.scissor),ne=M.scissorTest}else j.copy(Q).multiplyScalar(Le).floor(),J.copy(Se).multiplyScalar(Le).floor(),ne=we;if(H!==0&&(k=yl),ce.bindFramebuffer(N.FRAMEBUFFER,k)&&ce.drawBuffers(M,k),ce.viewport(j),ce.scissor(J),ce.setScissorTest(ne),G){const he=b.get(M.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+F,he.__webglTexture,H)}else if(fe){const he=F;for(let Ee=0;Ee<M.textures.length;Ee++){const ye=b.get(M.textures[Ee]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+Ee,ye.__webglTexture,H,he)}}else if(M!==null&&H!==0){const he=b.get(M.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,he.__webglTexture,H)}V=-1},this.readRenderTargetPixels=function(M,F,H,k,G,fe,ve,he=0){if(!(M&&M.isWebGLRenderTarget)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ee=b.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ve!==void 0&&(Ee=Ee[ve]),Ee){ce.bindFramebuffer(N.FRAMEBUFFER,Ee);try{const ye=M.textures[he],Ie=ye.format,Fe=ye.type;if(M.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+he),!nt.textureFormatReadable(Ie)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!nt.textureTypeReadable(Fe)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=M.width-k&&H>=0&&H<=M.height-G&&N.readPixels(F,H,k,G,I.convert(Ie),I.convert(Fe),fe)}finally{const ye=U!==null?b.get(U).__webglFramebuffer:null;ce.bindFramebuffer(N.FRAMEBUFFER,ye)}}},this.readRenderTargetPixelsAsync=async function(M,F,H,k,G,fe,ve,he=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ee=b.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ve!==void 0&&(Ee=Ee[ve]),Ee)if(F>=0&&F<=M.width-k&&H>=0&&H<=M.height-G){ce.bindFramebuffer(N.FRAMEBUFFER,Ee);const ye=M.textures[he],Ie=ye.format,Fe=ye.type;if(M.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+he),!nt.textureFormatReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!nt.textureTypeReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Te=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,Te),N.bufferData(N.PIXEL_PACK_BUFFER,fe.byteLength,N.STREAM_READ),N.readPixels(F,H,k,G,I.convert(Ie),I.convert(Fe),0);const Qe=U!==null?b.get(U).__webglFramebuffer:null;ce.bindFramebuffer(N.FRAMEBUFFER,Qe);const pt=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await dc(N,pt,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,Te),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,fe),N.deleteBuffer(Te),N.deleteSync(pt),fe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,F=null,H=0){const k=Math.pow(2,-H),G=Math.floor(M.image.width*k),fe=Math.floor(M.image.height*k),ve=F!==null?F.x:0,he=F!==null?F.y:0;g.setTexture2D(M,0),N.copyTexSubImage2D(N.TEXTURE_2D,H,0,0,ve,he,G,fe),ce.unbindTexture()};const Tl=N.createFramebuffer(),Al=N.createFramebuffer();this.copyTextureToTexture=function(M,F,H=null,k=null,G=0,fe=0){let ve,he,Ee,ye,Ie,Fe,Te,Qe,pt;const ut=M.isCompressedTexture?M.mipmaps[fe]:M.image;if(H!==null)ve=H.max.x-H.min.x,he=H.max.y-H.min.y,Ee=H.isBox3?H.max.z-H.min.z:1,ye=H.min.x,Ie=H.min.y,Fe=H.isBox3?H.min.z:0;else{const mt=Math.pow(2,-G);ve=Math.floor(ut.width*mt),he=Math.floor(ut.height*mt),M.isDataArrayTexture?Ee=ut.depth:M.isData3DTexture?Ee=Math.floor(ut.depth*mt):Ee=1,ye=0,Ie=0,Fe=0}k!==null?(Te=k.x,Qe=k.y,pt=k.z):(Te=0,Qe=0,pt=0);const et=I.convert(F.format),yt=I.convert(F.type);let ge;F.isData3DTexture?(g.setTexture3D(F,0),ge=N.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(g.setTexture2DArray(F,0),ge=N.TEXTURE_2D_ARRAY):(g.setTexture2D(F,0),ge=N.TEXTURE_2D),ce.activeTexture(N.TEXTURE0),ce.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,F.flipY),ce.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),ce.pixelStorei(N.UNPACK_ALIGNMENT,F.unpackAlignment);const Ut=ce.getParameter(N.UNPACK_ROW_LENGTH),Xe=ce.getParameter(N.UNPACK_IMAGE_HEIGHT),kt=ce.getParameter(N.UNPACK_SKIP_PIXELS),Zt=ce.getParameter(N.UNPACK_SKIP_ROWS),Mn=ce.getParameter(N.UNPACK_SKIP_IMAGES);ce.pixelStorei(N.UNPACK_ROW_LENGTH,ut.width),ce.pixelStorei(N.UNPACK_IMAGE_HEIGHT,ut.height),ce.pixelStorei(N.UNPACK_SKIP_PIXELS,ye),ce.pixelStorei(N.UNPACK_SKIP_ROWS,Ie),ce.pixelStorei(N.UNPACK_SKIP_IMAGES,Fe);const Yn=M.isDataArrayTexture||M.isData3DTexture,tt=F.isDataArrayTexture||F.isData3DTexture;if(M.isDepthTexture){const mt=b.get(M),Sn=b.get(F),it=b.get(mt.__renderTarget),En=b.get(Sn.__renderTarget);ce.bindFramebuffer(N.READ_FRAMEBUFFER,it.__webglFramebuffer),ce.bindFramebuffer(N.DRAW_FRAMEBUFFER,En.__webglFramebuffer);for(let $n=0;$n<Ee;$n++)Yn&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,b.get(M).__webglTexture,G,Fe+$n),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,b.get(F).__webglTexture,fe,pt+$n)),N.blitFramebuffer(ye,Ie,ve,he,Te,Qe,ve,he,N.DEPTH_BUFFER_BIT,N.NEAREST);ce.bindFramebuffer(N.READ_FRAMEBUFFER,null),ce.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(G!==0||M.isRenderTargetTexture||b.has(M)){const mt=b.get(M),Sn=b.get(F);ce.bindFramebuffer(N.READ_FRAMEBUFFER,Tl),ce.bindFramebuffer(N.DRAW_FRAMEBUFFER,Al);for(let it=0;it<Ee;it++)Yn?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,mt.__webglTexture,G,Fe+it):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,mt.__webglTexture,G),tt?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,Sn.__webglTexture,fe,pt+it):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,Sn.__webglTexture,fe),G!==0?N.blitFramebuffer(ye,Ie,ve,he,Te,Qe,ve,he,N.COLOR_BUFFER_BIT,N.NEAREST):tt?N.copyTexSubImage3D(ge,fe,Te,Qe,pt+it,ye,Ie,ve,he):N.copyTexSubImage2D(ge,fe,Te,Qe,ye,Ie,ve,he);ce.bindFramebuffer(N.READ_FRAMEBUFFER,null),ce.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else tt?M.isDataTexture||M.isData3DTexture?N.texSubImage3D(ge,fe,Te,Qe,pt,ve,he,Ee,et,yt,ut.data):F.isCompressedArrayTexture?N.compressedTexSubImage3D(ge,fe,Te,Qe,pt,ve,he,Ee,et,ut.data):N.texSubImage3D(ge,fe,Te,Qe,pt,ve,he,Ee,et,yt,ut):M.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,fe,Te,Qe,ve,he,et,yt,ut.data):M.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,fe,Te,Qe,ut.width,ut.height,et,ut.data):N.texSubImage2D(N.TEXTURE_2D,fe,Te,Qe,ve,he,et,yt,ut);ce.pixelStorei(N.UNPACK_ROW_LENGTH,Ut),ce.pixelStorei(N.UNPACK_IMAGE_HEIGHT,Xe),ce.pixelStorei(N.UNPACK_SKIP_PIXELS,kt),ce.pixelStorei(N.UNPACK_SKIP_ROWS,Zt),ce.pixelStorei(N.UNPACK_SKIP_IMAGES,Mn),fe===0&&F.generateMipmaps&&N.generateMipmap(ge),ce.unbindTexture()},this.initRenderTarget=function(M){b.get(M).__webglFramebuffer===void 0&&g.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?g.setTextureCube(M,0):M.isData3DTexture?g.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?g.setTexture2DArray(M,0):g.setTexture2D(M,0),ce.unbindTexture()},this.resetState=function(){W=0,X=0,U=null,ce.reset(),se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return nn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ge._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ge._getUnpackColorSpace()}}const ml=(...i)=>i.filter((e,t,n)=>!!e&&e.trim()!==""&&n.indexOf(e)===t).join(" ").trim();const Zp=i=>i.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase();const Jp=i=>i.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase());const Po=i=>{const e=Jp(i);return e.charAt(0).toUpperCase()+e.slice(1)};var cs={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};const Qp=i=>{for(const e in i)if(e.startsWith("aria-")||e==="role"||e==="title")return!0;return!1},em=ht.createContext({}),tm=()=>ht.useContext(em),nm=ht.forwardRef(({color:i,size:e,strokeWidth:t,absoluteStrokeWidth:n,className:r="",children:s,iconNode:a,...o},c)=>{const{size:l=24,strokeWidth:d=2,absoluteStrokeWidth:p=!1,color:u="currentColor",className:m=""}=tm()??{},v=n??p?Number(t??d)*24/Number(e??l):t??d;return ht.createElement("svg",{ref:c,...cs,width:e??l??cs.width,height:e??l??cs.height,stroke:i??u,strokeWidth:v,className:ml("lucide",m,r),...!s&&!Qp(o)&&{"aria-hidden":"true"},...o},[...a.map(([T,f])=>ht.createElement(T,f)),...Array.isArray(s)?s:[s]])});const vn=(i,e)=>{const t=ht.forwardRef(({className:n,...r},s)=>ht.createElement(nm,{ref:s,iconNode:e,className:ml(`lucide-${Zp(Po(i))}`,`lucide-${i}`,n),...r}));return t.displayName=Po(i),t};const im=[["path",{d:"M7 7h10v10",key:"1tivn9"}],["path",{d:"M7 17 17 7",key:"1vkiza"}]],rm=vn("arrow-up-right",im);const sm=[["path",{d:"M17.596 12.768a2 2 0 1 0 2.829-2.829l-1.768-1.767a2 2 0 0 0 2.828-2.829l-2.828-2.828a2 2 0 0 0-2.829 2.828l-1.767-1.768a2 2 0 1 0-2.829 2.829z",key:"9m4mmf"}],["path",{d:"m2.5 21.5 1.4-1.4",key:"17g3f0"}],["path",{d:"m20.1 3.9 1.4-1.4",key:"1qn309"}],["path",{d:"M5.343 21.485a2 2 0 1 0 2.829-2.828l1.767 1.768a2 2 0 1 0 2.829-2.829l-6.364-6.364a2 2 0 1 0-2.829 2.829l1.768 1.767a2 2 0 0 0-2.828 2.829z",key:"1t2c92"}],["path",{d:"m9.6 14.4 4.8-4.8",key:"6umqxw"}]],am=vn("dumbbell",sm);const om=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-6a2 2 0 0 1 2.582 0l7 6A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"r6nss1"}]],lm=vn("house",om);const cm=[["path",{d:"M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z",key:"nnexq3"}],["path",{d:"M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12",key:"mt58a7"}]],um=vn("leaf",cm);const hm=[["path",{d:"M15 18h-5",key:"95g1m2"}],["path",{d:"M18 14h-8",key:"sponae"}],["path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0v-9a2 2 0 0 1 2-2h2",key:"39pd36"}],["rect",{width:"8",height:"4",x:"10",y:"6",rx:"1",key:"aywv1n"}]],dm=vn("newspaper",hm);const fm=[["path",{d:"M16 10a4 4 0 0 1-8 0",key:"1ltviw"}],["path",{d:"M3.103 6.034h17.794",key:"awc11p"}],["path",{d:"M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z",key:"o988cm"}]],pm=vn("shopping-bag",fm);const mm=[["path",{d:"M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2",key:"cjf0a3"}],["path",{d:"M7 2v20",key:"1473qp"}],["path",{d:"M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7",key:"j28e5"}]],gm=vn("utensils",mm);const _m=[["path",{d:"M2 12q2.5 2 5 0t5 0 5 0 5 0",key:"8ddzzs"}],["path",{d:"M2 19q2.5 2 5 0t5 0 5 0 5 0",key:"1wj4st"}],["path",{d:"M2 5q2.5 2 5 0t5 0 5 0 5 0",key:"69x50u"}]],xm=vn("waves-horizontal",_m);const vm=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],Mm=vn("x",vm),gl=[{id:"pulseforge",title:"PulseForge",category:"Performance gym",palette:"Portfolio piece",accent:"#ff2d55",image:"/brand-images/pulseforge-sequence-01-entrance.webp",Icon:am,one:"A high-performance training club website."},{id:"atlas",title:"Atlas Estate",category:"Luxury real estate",palette:"Portfolio piece",accent:"#b78342",image:"/brand-images/atlas-estate.webp",Icon:lm,one:"A private coastal real estate website."},{id:"verdant",title:"Verdant Works",category:"Outdoor living",palette:"Portfolio piece",accent:"#7ba95b",image:"/brand-images/verdant-works.webp",Icon:um,one:"A grounded outdoor living website."},{id:"orbit",title:"Orbit Supply",category:"Product drop",palette:"Portfolio piece",accent:"#73f5ff",image:"/brand-images/orbit-supply.webp",Icon:pm,one:"A product drop website."},{id:"margin",title:"The Margin",category:"Magazine",palette:"Portfolio piece",accent:"#8c2f39",image:"/brand-images/the-margin.webp",Icon:dm,one:"A magazine website."},{id:"ember",title:"Ember Table",category:"Restaurant",palette:"Portfolio piece",accent:"#ffb347",image:"/brand-images/ember-table.webp",Icon:gm,one:"A restaurant website."},{id:"luma",title:"Luma Spa",category:"Wellness spa",palette:"Portfolio piece",accent:"#72c7ad",image:"/brand-images/luma-spa.webp",Icon:xm,one:"A wellness spa website."}],Sm=Object.fromEntries(gl.map(i=>[i.id,i])),Em=ht.lazy(()=>Cl(()=>import("./PulseForgeWalkthrough.DUAVoLTs.js"),__vite__mapDeps([0,1]))),ur=[["Entrance","Branded reception","Concrete desk, red wall mark, first look into the club."],["Turf","Sled lane","Green turf, hash marks, rubber floor, and racks ahead."],["Strength","Racks + dumbbells","Rack line, benches, mirrors, plates, and steel frames."],["Conditioning","Rowers + bikes","Engine work with rowers, bikes, ropes, and kettlebells."],["Recovery","Cold + compression","Glass recovery room, plunge, table, and compression chairs."],["Trial Pass","Final step","The final desk view resolves into a seven-day trial pass."]];function bm(i){if(!i)return 0;const e=Math.max(1,i.scrollHeight-i.clientHeight);return Math.min(1,Math.max(0,i.scrollTop/e))}function qn({site:i,className:e="",alt:t,shade:n=!0}){return S.jsx(Dn,{src:i.image,alt:t||`${i.title} brand photography`,className:e,shade:n})}function Dn({src:i,className:e="",alt:t="",shade:n=!0}){return S.jsxs("div",{className:`brand-photo ${e}`,children:[S.jsx("img",{src:i,alt:t,loading:"lazy"}),n&&S.jsx("span",{className:"brand-photo-shade"})]})}function _l({viewBox:i,paths:e,progress:t=0,className:n="",children:r}){const s=ht.useRef([]),[a,o]=ht.useState([]),c=e.map(l=>l.d).join("|");return ht.useEffect(()=>{const l=()=>o(s.current.map(p=>p?.getTotalLength?.()||1));l();const d=typeof ResizeObserver<"u"?new ResizeObserver(l):null;return s.current.forEach(p=>p&&d?.observe(p)),window.addEventListener("resize",l),()=>{d?.disconnect(),window.removeEventListener("resize",l)}},[c]),S.jsxs("svg",{className:`scroll-draw ${n}`,viewBox:i,fill:"none","aria-hidden":"true",children:[e.map((l,d)=>{const p=a[d]||1,u=l.start??0,m=l.end??1,v=Math.min(1,Math.max(0,(t-u)/Math.max(.001,m-u)));return S.jsx("path",{ref:T=>{s.current[d]=T},d:l.d,stroke:l.stroke,strokeWidth:l.strokeWidth||4,strokeLinecap:"round",strokeLinejoin:"round",style:{strokeDasharray:p,strokeDashoffset:p*(1-v)}},`${l.d}-${d}`)}),r]})}function ym({variant:i="fly",active:e=!1,scrollProgress:t=0}){const n=ht.useRef(null),r=ht.useRef({x:0,y:0}),s=ht.useRef(t);return ht.useEffect(()=>{s.current=t},[t]),ht.useEffect(()=>{if(!n.current)return;const a=n.current,o=new Rc,c=new Bt(i==="fly"?62:48,1,.1,220);c.position.set(0,0,i==="fly"?13:6.2);const l=new Kp({alpha:!0,antialias:!0,powerPreference:"high-performance"});l.setPixelRatio(Math.min(window.devicePixelRatio||1,1.45)),a.appendChild(l.domElement);const d=[],p=performance.now();let u=0;const m={uTime:{value:0},uScroll:{value:0},uMouse:{value:new He(0,0)},uColorA:{value:new qe(i==="fly"?"#ff2d55":"#73f5ff")},uColorB:{value:new qe(i==="fly"?"#ffffff":"#9b5cff")}};if(i==="fly"){o.fog=new da("#050306",.034);const h=(L,j,J=0)=>(o.add(L),d.push({mesh:L,kind:j,phase:J}),L),x=(L,j=1,J=!1)=>new Ci({color:L,transparent:j<1,opacity:j,wireframe:J}),y=x("#15171b",.96),E=x("#123f2c",.92),R=x("#9aa1aa",.5),A=x("#dce9ef",.24,!0),C=x("#ff2d55",.82),_=x("#ffffff",.45),w=x("#050608",.95),D=x("#49d17a",.7),P=[{name:"ENTRANCE",z:6,color:"#ffffff"},{name:"TURF LANE",z:-8,color:"#49d17a"},{name:"STRENGTH",z:-23,color:"#ff2d55"},{name:"CONDITIONING",z:-41,color:"#ffbd38"},{name:"RECOVERY",z:-61,color:"#72c7ad"}],O=(L,j="#ff2d55")=>{const J=document.createElement("canvas");J.width=512,J.height=128;const ne=J.getContext("2d");ne.clearRect(0,0,512,128),ne.fillStyle="rgba(0,0,0,.58)",ne.fillRect(0,0,512,128),ne.strokeStyle=j,ne.lineWidth=6,ne.strokeRect(6,6,500,116),ne.fillStyle="#ffffff",ne.font="700 42px Arial",ne.textAlign="center",ne.textBaseline="middle",ne.fillText(L,256,66);const _e=new zc(J);_e.needsUpdate=!0;const Me=new ke(new Fi(2.45,.62),new Ci({map:_e,transparent:!0,opacity:.9}));return Me.userData.map=_e,Me};for(let L=0;L<42;L+=1){const j=7-L*1.78;h(new ke(new at(7.9,.05,1.72),y.clone()),"floor",L).position.set(0,-1.72,j);const ne=h(new ke(new at(7.7,.018,.018),_.clone()),"rubber-seam",L);if(ne.position.set(0,-1.675,j-.78),ne.material.opacity=.1,h(new ke(new at(1.25,.065,1.68),E.clone()),"turf",L).position.set(-1.45,-1.66,j),h(new ke(new at(.035,.08,1.6),D.clone()),"sled",L).position.set(-1.92,-1.59,j),h(new ke(new at(.035,.08,1.6),D.clone()),"sled",L).position.set(-.98,-1.59,j),h(new ke(new at(.05,2.65,1.72),L%5===0?A.clone():w.clone()),"wall",L).position.set(-3.95,-.35,j),h(new ke(new at(.05,2.65,1.72),L%6===0?A.clone():w.clone()),"wall",L).position.set(3.95,-.35,j),h(new ke(new at(7.9,.05,.05),R.clone()),"frame",L).position.set(0,1.02,j-.78),h(new ke(new at(2.2,.035,.16),L%3===0?C.clone():_.clone()),"light",L).position.set(L%2?-1.7:1.7,1.22,j-.35),L>10&&L<24&&L%3===0&&[-3.2,2.85].forEach((Q,Se)=>{h(new ke(new at(.06,1.45,.08),R.clone()),"equipment",L).position.set(Q,-.92,j),h(new ke(new at(.06,1.45,.08),R.clone()),"equipment",L).position.set(Q+(Se?-.62:.62),-.92,j),h(new ke(new at(.94,.05,.05),_.clone()),"equipment",L).position.set(Q+(Se?-.31:.31),-.48,j),[-.36,.36].forEach(Oe=>{const $e=h(new ke(new pa(.18,.18,.06,18),C.clone()),"equipment",L);$e.position.set(Q+Oe,-.48,j),$e.rotation.z=Math.PI/2})}),L>17&&L<30&&L%4===0)for(let Q=0;Q<5;Q+=1)h(new ke(new at(.32,.06,.08),_.clone()),"dumbbell",L+Q).position.set(3.73,-1.25+Q*.18,j-.45),h(new ke(new at(.08,.12,.12),C.clone()),"dumbbell",L+Q).position.set(3.74,-1.25+Q*.18,j-.62);if(L>24&&L<34&&L%3===1){h(new ke(new at(.72,.06,.18),R.clone()),"bike",L).position.set(2.45,-1.38,j);const Se=h(new ke(new ui(.22,.018,8,24),_.clone()),"bike",L);Se.position.set(2.18,-1.15,j),Se.rotation.y=Math.PI/2;const we=h(new ke(new ui(.18,.015,8,24),_.clone()),"bike",L);we.position.set(2.72,-1.17,j),we.rotation.y=Math.PI/2,h(new ke(new at(.95,.04,.12),D.clone()),"rower",L).position.set(-3,-1.42,j)}if(L>28&&L<38&&L%5===0){const Q=h(new ke(new ui(.48,.026,8,72),C.clone()),"rope",L);Q.position.set(-3.55,-.42,j),Q.rotation.y=Math.PI/2}if(L>33&&L%3===0){h(new ke(new at(1.4,.16,.52),x("#72c7ad",.5)),"recovery",L).position.set(L%2?-2.8:2.8,-1.34,j);const Se=O("RECOVERY","#72c7ad");Se.position.set(L%2?-3.87:3.87,.42,j-.2),Se.rotation.y=L%2?Math.PI/2:-Math.PI/2,h(Se,"sign",L)}if(L%8===0){const Q=h(new ke(new at(2.3,2.05,.055),A.clone()),"doorway",L);Q.position.set(L%16===0?-3.9:3.9,-.43,j-.68),Q.rotation.y=Math.PI/2}}P.forEach((L,j)=>{const J=O(L.name,L.color);J.position.set(0,.75,L.z),h(J,"zone-label",j),h(new ke(new at(6.8,.04,.08),x(L.color,.58)),"zone-gate",j).position.set(0,1.03,L.z-.6)});const W=new It,X=420,U=new Float32Array(X*3);for(let L=0;L<X;L+=1)U[L*3]=(Math.random()-.5)*6.6,U[L*3+1]=-1.45+Math.random()*2.2,U[L*3+2]=9-Math.random()*84;W.setAttribute("position",new Yt(U,3));const V=new Bc(W,new el({color:"#ffffff",size:.018,transparent:!0,opacity:.28}));o.add(V),d.push({mesh:V,kind:"particles",phase:0})}else{const h=new ga(1.6,96),x=new $t({uniforms:m,transparent:!0,vertexShader:`
